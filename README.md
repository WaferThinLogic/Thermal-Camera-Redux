# Thermal-Camera-Redux
 ...
 Topdon TC001 (and clones: Topdon TS001, InfiRay P2 Pro, MaAnt Super IR Cam, etc.) and Thermal Master P1 Linux thermal camera app to read and display live and offline thermal data.<br />
